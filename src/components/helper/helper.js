...
export const request = {
  get: function (services) {
    ...
    return axios.get(`${host}/api${services}`, {
      headers: {
  ...
  post: function (services, data) {
    let token = renovarSesion();
    return axios.post(`${host}/api${services}`, data, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  put: function (services, data) {
    let token = renovarSesion();
    return axios.put(`${host}/api${services}`, data, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  delete: function (services) {
    let token = renovarSesion();
    return axios.delete(`${host}/api${services}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
